						...
						<div class="clearfix">
							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-stat" style="background-color: rgb(255, 208, 0); color: rgb(31, 29, 29);">
										<div class="row">
							...
							<?php if($this->session->userdata('level')=='admin'){?>
								<a href="<?=base_url('index.php/Kasir')?>" style="color: rgb(31, 29, 29);">
								<?php }?>
									<div class="metric">
								...
								<a href="<?=base_url('index.php/Histori')?>" style="color: rgb(31, 29, 29);">
									<div class="metric">
								...
								<div class="col-md-4">
								<a href="<?=base_url('index.php/Sepatu')?>" style="color: rgb(31, 29, 29);">
									<div class="metric">
