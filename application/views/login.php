				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width:300px;">
							<div class="header">
								<div class="logo text-center"><img src="<?= base_url()?>assets/img/sepatu2.png" alt="Klorofil Logo" style="width:200px;"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Welcome to Troops</h1>
							<p>Dapatkan diskon 50% tiap bulannya</p>
						</div>
					</div>
